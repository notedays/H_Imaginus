...
public enum Skill {
	...
	//공통
	KNIFE_THROW(1,0,"단검 던지기","무사들의 기본 기술로 단검을 던져 적을 공격한다.", 0, 6, 1),
	
	//1. 무휼
	ONE_SLASH(1, 1,"일단 베기","무휼이 어릴때 배운 한단 베기", 1, 10, 1),
	LIGHT_SLASH(1, 1,"빛단 베기","무휼이 어릴때 배운 빛단 베기", 2, 15, 1),
	SPEED_LIGHT_SLASH(1, 1,"빠른 빛단 베기","무휼이 어릴때 배운 빠른 빛단 베기", 3, 20, 1);
