...
public class Main {
	...
	public Main() {
		...
		do {
			...
			System.out.print("1. 새로 시작하기...");
			System.out.print("2. 이어서 하기...");
			System.out.print("3. 불러 오기...");
			System.out.print("4. 종료 하기...");
			choice = sc.nextInt();

		switch (choice) {
		case 1: { // 새로 시작하기
			System.out.print("새로 시작할 이용자 이름을 입력하시오...");
			...
			int menuChoice=0;
			while (menuChoice != 6) {
				System.out.print("1. 붕어빵 만들기...");
				System.out.print("2. 붕어빵 팔기...");
				System.out.print("3. 진급하기...");
				System.out.print("4. 상점이용하기...");
				System.out.print("5. 반죽만들기...");
				System.out.print("6. 이전 화면으로...");
				...
				case 4: {
					...
					System.out.print("구매 할 아이템의 번호를 입력하시오[1 ~ 4]");
				...
				case 5: {
					...
					System.out.print("반죽을 몇개 만들겠습니까?");
